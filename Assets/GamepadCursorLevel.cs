...
public class GamepadCursorLevel : StandaloneInputModule
{
    ...
    private void OnGUI()
    {
        if (Hinput.anyGamepad.isConnected == true && PauseMenu.isActive || OpenInventory.isActive == false || OpenBook.isBookEnabled == false || OpenStorageBook.isActive == false || ActiveShop.isShopEnabled || LifePlayer.isDeath)
        {
